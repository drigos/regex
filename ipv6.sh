...
RE_IPV6="(${HEXADECATETO}:){7,7}${HEXADECATETO}|"                    # TEST: 1:2:3:4:5:6:7:8
...
RE_IPV6="${RE_IPV6}(${HEXADECATETO}:){1,5}(:${HEXADECATETO}){1,2}|"  # TEST: 1::7:8           1:2:3:4:5::7:8  1:2:3:4:5::8
RE_IPV6="${RE_IPV6}(${HEXADECATETO}:){1,4}(:${HEXADECATETO}){1,3}|"  # TEST: 1::6:7:8         1:2:3:4::6:7:8  1:2:3:4::8
RE_IPV6="${RE_IPV6}(${HEXADECATETO}:){1,3}(:${HEXADECATETO}){1,4}|"  # TEST: 1::5:6:7:8       1:2:3::5:6:7:8  1:2:3::8
RE_IPV6="${RE_IPV6}(${HEXADECATETO}:){1,2}(:${HEXADECATETO}){1,5}|"  # TEST: 1::4:5:6:7:8     1:2::4:5:6:7:8  1:2::8
RE_IPV6="${RE_IPV6}${HEXADECATETO}:((:${HEXADECATETO}){1,6})|"       # TEST: 1::3:4:5:6:7:8   1::3:4:5:6:7:8  1::8
RE_IPV6="${RE_IPV6}:((:${HEXADECATETO}){1,7}|:)|"                    # TEST: ::2:3:4:5:6:7:8  ::2:3:4:5:6:7:8 ::8       :: 
RE_IPV6="${RE_IPV6}fe08:(:${HEXADECATETO}){2,2}%[0-9a-zA-Z]{1,}|"    # TEST: fe08::7:8%eth0      fe08::7:8%1                                      (link-local IPv6 addresses with zone index)
...
RE_IPV6="${RE_IPV6}(${HEXADECATETO}:){1,4}:${RE_IPV4}"               # TEST: 2001:db8:3:4::192.0.2.33  64:ff9b::192.0.2.33                        (IPv4-Embedded IPv6 Address)
